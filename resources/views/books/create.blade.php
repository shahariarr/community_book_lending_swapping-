                        ...
                        <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <select name="book_category_id" id="book_category_id"
                                            ...
                                            @foreach($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    {{ old('book_category_id', $selectedCategory) == $category->id ? 'selected' : '' }}>
                                                    {{ $category->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="availability_status" id="availability_status"
                                            ...
                                            <option value="Borrowed" {{ old('availability_status') == 'Borrowed' ? 'selected' : '' }}>Borrowed</option>
                            ...
                            <div class="form-group">
                                ...
                                @error('cover_image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">Upload book cover image (max 2MB, jpg/png/gif)</small>
                            </div>
